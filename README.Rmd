...
The goal of rpackages is to make regular expressions more exciting!
...
You can install the development version of rpackages from [GitHub](https://github.com/) with:
